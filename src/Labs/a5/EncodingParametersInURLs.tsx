...
function EncodingParametersInURLs() {
  ...
  return (
    <div>
      ...
      <input className="form-control m-2" value={result} type="number" readOnly />
      
      <h3>Fetch Result</h3>
      <button className="btn btn-primary w-50 m-2" onClick={() => fetchSum(a, b)} >
        Fetch Sum of {a} + {b}
      </button>
      <br/>
      <button className="btn btn-danger w-50 m-2" onClick={() => fetchSubtraction(a, b)} >
